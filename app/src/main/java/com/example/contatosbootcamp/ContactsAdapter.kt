...
class ContactsAdapter (val contactsList: ArrayList<Contact>): RecyclerView.Adapter<ContactsAdapter.ViewHolder>(){
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bindItem(contact: Contact){
            ...
            val textNameContato = itemView.findViewById<TextView>(R.id.contact_txt_name)
            val textPhoneNumberContato = itemView.findViewById<TextView>(R.id.contact_txt_phone_number)

            textNameContato.text = contact.name
            textPhoneNumberContato.text = contact.phoneNumber
        }
